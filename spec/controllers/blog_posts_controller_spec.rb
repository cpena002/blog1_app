...
RSpec.describe BlogPostsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested blog_post as @blog_post" do
      blog_post = BlogPost.create! valid_attributes
      get :show, params: {id: blog_post.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested blog_post as @blog_post" do
      blog_post = BlogPost.create! valid_attributes
      get :edit, params: {id: blog_post.to_param}, session: valid_session
      expect(assigns(:blog_post)).to eq(blog_post)
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested blog_post" do
        blog_post = BlogPost.create! valid_attributes
        put :update, params: {id: blog_post.to_param, blog_post: new_attributes}, session: valid_session
        blog_post.reload
      ...
      it "assigns the requested blog_post as @blog_post" do
        blog_post = BlogPost.create! valid_attributes
        put :update, params: {id: blog_post.to_param, blog_post: valid_attributes}, session: valid_session
        expect(assigns(:blog_post)).to eq(blog_post)
      end
    ...
    context "with invalid params" do
      it "assigns the blog_post as @blog_post" do
        blog_post = BlogPost.create! valid_attributes
        put :update, params: {id: blog_post.to_param, blog_post: invalid_attributes}, session: valid_session
        expect(assigns(:blog_post)).to eq(blog_post)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested blog_post" do
      blog_post = BlogPost.create! valid_attributes
      expect {
        delete :destroy, params: {id: blog_post.to_param}, session: valid_session
      }.to change(BlogPost, :count).by(-1)
    end
